...
#     sample_skills = ["Python", "SQL", "Machine Learning", "Data Visualization"]

#     sample_news_trends = (
#         "AI adoption is accelerating across industries in 2025. "
#         "Companies are heavily investing in cloud infrastructure and data platforms. "
#         "Cybersecurity threats have surged, driving urgent hiring in security roles. "
#         "Web development demand remains steady with a shift toward full-stack and AI-integrated apps."
#     )

#     print("Running Market Demand Analyzer Agent...")
#     print(f"Careers: {sample_careers}")
#     print(f"Skills : {sample_skills}")

#     try:
#          NOTE: Ensure GROQ_API_KEY is set in your environment,
#          or pass anthropic_api_key="sk-..." explicitly.
#         result = run_market_demand_agent(
#             careers=sample_careers,
#             skills=sample_skills,
#             news_trends=sample_news_trends,
#         )

#         # Pretty print for demo
#         print_analysis(result)

#         # Raw dict — ready for downstream agents
#         print("Raw dict output (for multi-agent integration):")
